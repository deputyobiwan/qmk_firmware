...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
     [_COLEMAK_DH] = LAYOUT(
       KC_Q, KC_W, KC_F, KC_P, KC_B,                                             KC_J, KC_L, U_Ü_MACRO, DE_Y, DE_SS,
       A_Ä_MACRO, LALT_T(KC_R), LCTL_T(KC_S), LSFT_T(KC_T), LGUI_T(KC_G),        LGUI_T(KC_M), RSFT_T(KC_N), CTL_T(KC_E), LALT_T(KC_I), O_Ö_MACRO,
       DE_Z, KC_X, KC_C, KC_D, KC_V,                                             KC_K, KC_H, COMMA_SEMICOLON_MACRO, DOT_COLON_MACRO, MINUS_UNDERSCORE_MACRO,
            LT(_NUM,KC_ENTER), LT(_SYM,KC_SPACE),                           LT(_NAV_MED,KC_BACKSPACE), LT(_MS,KC_TAB)
    ),
    ...
    */
     [_NAV_MED] = LAYOUT(
       KC_NO, KC_NO, KC_UP, KC_NO, KC_NO,                                                  KC_ESCAPE, KC_NO, KC_PAGE_UP, KC_NO, KC_NO,
       KC_HOME, KC_LEFT, KC_DOWN, KC_RIGHT, KC_END,                                        KC_DELETE, KC_NO, KC_PAGE_DOWN, KC_NO, KC_NO,
       KC_MEDIA_PLAY_PAUSE, KC_AUDIO_MUTE, KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP, KC_NO,      KC_BACKSPACE, LCTL(KC_C), LCTL(KC_V), LCTL(KC_X), QK_BOOTLOADER,
            KC_LCTL, KC_LSFT,                                               KC_TRANSPARENT, KC_NO
    ),
    ...
    */
     [_MS] = LAYOUT(
       KC_NO, KC_NO, KC_MS_UP, KC_NO, KC_NO,                                     KC_NO, KC_MS_WH_LEFT, KC_MS_WH_UP, KC_MS_WH_RIGHT, MOUSEJIGGLERMACRO,
       KC_NO, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_NO,                        KC_WWW_BACK, KC_MS_BTN1, KC_MS_WH_DOWN, KC_MS_BTN2, KC_WWW_FORWARD,
       KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                        KC_NO, LCTL(KC_C), LCTL(KC_V), LCTL(KC_X), KC_NO,
    ...
    */
     [_FUN] = LAYOUT(
       GITSP, GITRE, GITBA, GITPS, KC_NO,                                           KC_NO, KC_F7, KC_F8, KC_F9, KC_F10,
       GITAP, GITCM, GITDF, GITST, KC_NO,                                           KC_NO, KC_F4, KC_F5, KC_F6, KC_F11,
       GITSH, GITRS, GITCH, GITPL, GITSE,                                           KC_NO, KC_F1, KC_F2, KC_F3, KC_F12,
