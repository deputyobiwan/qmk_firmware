...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
     [_COLEMAK_DH] = LAYOUT(
       ...
       KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_G,                                  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
       KC_NO, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_NO, KC_NO,      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
